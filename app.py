...
st.set_page_config(
    page_title="Previsão de Níveis de Obesidade",
    page_icon="🩺",
    layout="wide",
)
...
with col1:
    st.markdown("<h1 style='text-align: left; color: #0077B6;'>🩺 Predição de Níveis de Obesidade</h1>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: left;'>Preencha os dados na barra lateral à esquerda e clique no botão abaixo para realizar a predição.</p>", unsafe_allow_html=True)
with col2:
    if accuracy:
